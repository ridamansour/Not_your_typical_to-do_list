...
public class AddTaskFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        calendarImageView.setOnClickListener(v -> {
            ...
            DatePickerDialog datePickerDialog = new DatePickerDialog(requireActivity(), (view12, year, monthOfYear, dayOfMonth) -> {
    ...
    private void saveTaskToFirebase(String title, String date, String time, String content) {
        ...
        if (isConnected) {
            ...
            userTasksRef.child(Objects.requireNonNull(taskId)).setValue(task)
